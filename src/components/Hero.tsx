  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/4 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/[0.02] blur-[120px]" />
        <div className="absolute left-1/3 top-1/2 h-[400px] w-[400px] -translate-x-1/2 rounded-full bg-white/[0.015] blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        >
          <a
            href="#events"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-3 text-sm font-medium text-black transition-all hover:bg-white/90"
          >
            Explore Events
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="gradient-border inline-flex items-center justify-center gap-2 rounded-full bg-white/[0.03] px-8 py-3 text-sm font-medium text-white transition-all hover:bg-white/[0.06]"
          >
            Join Discord
          </a>
        </motion.div>
